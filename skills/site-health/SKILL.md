...
| Ahrefs Site Audit: provider Health Score, crawl freshness, crawled URLs, errors/warnings/notices | Run `node scripts/ahrefs-site-audit-health.mjs`; see [Ahrefs Site Audit health](../../docs/ahrefs-site-audit.md) |
